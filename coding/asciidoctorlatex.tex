...
\begin{document}
\maketitle
\hypertarget{x-some-equations}{\section*{Some Equations}}
\hypertarget{x-number-theory}{\subsection*{Number Theory}}
The equation
...
\hypertarget{x-calculus}{\subsection*{Calculus}}
A definite integral:
...
\hypertarget{x-linear-algebra}{\subsection*{Linear algebra}}
A matrix:

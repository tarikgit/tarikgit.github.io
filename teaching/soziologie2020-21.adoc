...
| 23/10/2020
| Feedback
| 1. link:https://tarikgit.github.io/teaching/soziologie-cours/08-Mindmap-strukturierte-Antwort-2.pdf[Erläutern Sie am Beispiel der Bitnation, und im Vergleich mit unserer Gesellschaft, die Merkmale des Begriffs _Gesellschaft_] +

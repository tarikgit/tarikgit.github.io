...
|*(1)* link:https://www.youtube.com/watch?v=ejJRhn53X2M[_Adam Smith_] (the link:https://www.youtube.com/watch?v=-CqMMxsN_7c["_invisible hand_"]), and _Jean-Baptiste Say_ ("_Say's Law_"). See link:https://www.economist.com/schools-brief/2017/08/12/says-law-supply-creates-its-own-demand[Say's law: supply creates its own demand]. The link:../slides/13-Says-Law.pdf[slides presented in our Meeting]. +
...
|21/4
|Market failure and  inefficient allocation of resources
|*(1)* MCQ in Microsoft Forms (see Teams). You can revise yesterday's material using the link:../slides/13-Says-Law.pdf[following slides] +
 *(2)* Write the following 12-mark essay and submit in Teams: _Discuss whether resources are more effectively allocated in a planned economy or in a market economy._ 

|
|24/4
|Government microeconomic intervention: subsidies 
|*(1)* link:https://www.youtube.com/watch?v=v_E2F6hBt80[Subsidies: Consumer and Producer Benefit] +
 *(2)* _Improve your answer_ (page 53 in your workbook)

|
|27/4
|The macroeconomy 
|*(1)* link:https://www.youtube.com/watch?v=Ma4PtoGfq5o&list=PLp8BSCLLWBUDAMwWdVpicMmFIPtqIYr8V&index=2[Economics of volatility (1)] +
 *(2)* link:https://www.youtube.com/watch?v=ox6Rv70yw8w&list=PLp8BSCLLWBUDAMwWdVpicMmFIPtqIYr8V[Reducing Currency Volatility (2)] +
 *(3)* link:https://www.youtube.com/watch?v=FORvo8u3Xs0&list=PLp8BSCLLWBUDAMwWdVpicMmFIPtqIYr8V&index=3[Currency depreciation and competitiveness (_essay writing_)] +
 *(4)* link:https://www.youtube.com/watch?v=zBOpbNmdWOs&list=PLp8BSCLLWBUDAMwWdVpicMmFIPtqIYr8V&index=4[Advantages and disadvantages of currency appreciation] +
 *(5)* Answer the MCQ in Forms (see _Assignments_) +
 *(6)* _Review your answer_ (page 66 in your workbook) +
 *(7)* Submit your answer in _Teams Assignment_ (together with your coursework of 24/4)


|
|28/4
|Government macro intervention 
|*(1)* link:https://www.youtube.com/watch?v=UAA6LavH-0U[Introduction to Monetary Policy (9 min)] +
 *(2)* link:https://www.youtube.com/watch?v=0AwfNL6F_mM[Quantitative Easing (8 min)] +
 *(3)* link:https://www.youtube.com/watch?v=8-XvrrL3Ywc[Causes of Inflation (7 min)] +
 *(4)* link:https://www.youtube.com/watch?v=K1XxE1uqiNM[Monetary Policy (10 min)] +
 *(6)* _Review your answer_ (page 74 in your workbook) +
 *(7)* Submit your answer in _Teams Assignment_ 

|
|4/5
|Taxes
|*(1)* Watch the short video link:https://www.youtube.com/watch?v=Y0xwmGM0DOY[Should we tax the rich more?] +
 *(2)* Watch link:https://www.youtube.com/watch?v=TMmDebW_OBI[Was Karl Marx right?] +
 *(3)* Watch link:https://www.youtube.com/watch?v=yr49wHVa8eM[How to revive public healthcare] +

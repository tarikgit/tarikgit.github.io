...
|
|23/4/2020
|_30: Accounting fundamentals (Part 2)_
|*(1)* link:../slides/23-AccountingFundamentals-B.pdf[Presentation] +
 *(2)* Upload Activities 30.3 and 30.4 into _Assignments_. + 
 *Hint*: Use the link:business-keyterms.html[keyterms webpage] when writing your answers. +

|
|24/4/2020
|_30: Accounting fundamentals (Part 3)_
|*(1)* link:../slides/23-AccountingFundamentals.pdf[Presentation] +
 *(2)* Upload Activities 30.5 and 30.6 into _Assignments_. + 
 *Hint*: Use the link:business-keyterms.html[keyterms webpage] when writing your answers. +

|
|27/4/2020
|_30: Accounting fundamentals (Revision videos)_
|*(1)* link:https://www.youtube.com/watch?v=Syu2sKv05rQ[Balance Sheet (7 min)] +
 *(2)* link:https://www.youtube.com/watch?v=or3bOLtAV4s[Income statement (6 min)] +
 *(3)* link:https://www.youtube.com/watch?v=GoKIZqSFMIE[Ratio Analysis (7 min)] +
 *(2)* Upload Activities 30.7 and 30.8 into _Assignments_. + 
 *Hint*: Use the link:business-keyterms.html[keyterms webpage] when writing your answers. +
...
|*(1)* link:../slides/24-ForecastingCashFlows.pdf[Presentation] +
 *(2)* link:https://www.youtube.com/watch?v=dLHZy4DWKRM[Introduction to the Cash Flow Forecast (6 min)] +
 *(3)* link:https://www.youtube.com/watch?v=P6sJYQEo4Dw[Cashflow Management - Improving Cash Flow (8 min)] +
 *(4)* link:https://www.youtube.com/watch?v=HxYjB6cHKXA[Cash Flow - Causes of Cash Flow Problems (6 min)] 

|
|7/5/2020
|
|*(1)* link:https://www.ft.com/video/4254fd92-4619-483c-8f4b-9c1613169a86?playlist-name=section-c47f4dfc-6879-4e95-accf-ca8cbe6a1f69&playlist-offset=42[What Thomas Cook collapse means for customers and investors (7 min)] (or link:https://www.youtube.com/watch?v=LCaBnMSP3JE[Youtube]) +
 *(2)* link:https://www.ft.com/video/047605a1-929a-40bc-b2c9-ac98b36f7100?playlist-name=section-c47f4dfc-6879-4e95-accf-ca8cbe6a1f69&playlist-offset=49[What Starbucks tells us about the US economy (3 min)] (or link:https://www.youtube.com/watch?v=dsKotrVXO8k[Youtube]) +
 *(3)* link:https://www.ft.com/video/e6a60bf9-df52-47ec-acfd-db9e7ef55b00?playlist-name=section-c47f4dfc-6879-4e95-accf-ca8cbe6a1f69&playlist-offset=21[Gojek and Grab: the rise of the south-east Asian super app (9 min)] (or link:https://www.youtube.com/watch?v=ssGhuFOYqvw[Youtube]) +
 *(4)* Answer the multiple-choice questions in _Assignments_ 

...
| 6/12/21
| *Examen* : +
  - Wie erklären Marx und Engels die Entstehung von sozialen Ungleichheiten? (10 Punkte) +
  - Erklären Sie wie sich laut Marx die „Wirklichkeit strukturiert“. (6 Punkte) +
  - Unterscheiden Sie die Begriffe „Kapital“ und „Vermögen“. Nennen Sie jeweils ein Beispiel. (4 Punkte)
|
|
